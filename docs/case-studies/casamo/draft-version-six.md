...
In the sample report, one property lists Wi-Fi, but there’s no evidence of its speed. Casamo marks it as listed and suggests asking the host for a recent speed test. For air conditioning, the report shows an excerpt from a guest’s review, with links to the full review and original text. The report brings those sources together around the traveler’s priorities and shows what still needs checking.
...
People testing Casamo wanted to see more options before trusting the recommendation. That made sense to me. They were choosing somewhere to spend weeks of their lives and thousands of dollars. They wanted more options to compare before trusting that the search had been thorough.
