        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center mb-6">
            <Image
              ...
              width={160}
              height={160}
              className="animate-fadeInUp drop-shadow-2xl"
              style={{ filter: 'drop-shadow(0 25px 50px rgba(0, 0, 0, 0.15))' }}
            />
          </div>
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 animate-fadeInUp animation-delay-100">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto animate-fadeInUp animation-delay-200">
