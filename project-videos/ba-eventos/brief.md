...
- Screenshot: public BA Eventos hero screenshot from the portfolio case study.
...
- Hide: private account/session details, tokens, cookies, and local paths.
- Safe to show: public logged-out product screenshots, public project name, synthetic source cards, and public catalog statistics.
