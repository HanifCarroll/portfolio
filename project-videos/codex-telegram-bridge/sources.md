# Codex Telegram Bridge Video Sources

## Reviewed Portfolio Sources

- `src/lib/projects/codex-telegram-bridge.json`
- `src/content/case-studies/codex-telegram-bridge.mdx`
- `src/assets/img/projects/codex-telegram-bridge-terminal.png`
- `docs/project-videos/capture-and-production-workflow.md`
- `docs/project-videos/project-video-source-template.md`
- `docs/project-videos/project-video-plan.md`

## Existing Video Patterns Reviewed
...
The composition does not use live Telegram, Discord, Codex thread, database, or local runtime screenshots. All message, route, approval, daemon, and thread visuals are synthetic labels created in HyperFrames. No tokens, raw thread ids, local paths, private messages, user handles, or runtime state are shown.
