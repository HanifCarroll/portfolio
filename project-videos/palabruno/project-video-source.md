...
| Launch surface | iOS, Android, web, payments, store pages, support notes              | `src/lib/projects/palabruno.json`; `/Users/hanifcarroll/projects/palabruno/docs/current-state.md`                | Yes                                                               | Yes, as native cards    |
...
```text
The launch included mobile apps, web, payments, store pages, and support notes.
```
...
| 5     | The launch included mobile apps, web, payments, store pages, and support notes.        |         11 |     6.5s | 102 |
...
- Native launch cards for iOS, Android, web, payments, store pages, and support notes.
