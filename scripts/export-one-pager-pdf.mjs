...
function resolveBrowserPath() {
	...
	if (!browserPath) {
		throw new Error('No Playwright Chromium executable found. Run `bunx playwright install chromium` or set CHROME_PATH.');
	}
...
function findCachedPlaywrightChromium() {
	...
	for (const version of versions) {
		...
		for (const platformDir of platformDirs) {
			const candidate = join(browserRoot, platformDir, 'Google Chrome for Testing.app', 'Contents', 'MacOS', 'Google Chrome for Testing');
