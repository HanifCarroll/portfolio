    ...
    const projects = [
        {
            ...
            description:
                "A tool to help language learners practice reading in their target language by providing them with high quality Wikipedia articles",
                    ...
                    <div className="relative">
                        ...
                        >
                            <h1 className="font-editorial text-[clamp(2.5rem,5vw,4.5rem)] leading-[1.1] text-[var(--foreground)] mb-8">
                                My mission is to help premium service businesses
                            ...
                            <div className="prose prose-lg text-[var(--muted)] space-y-6">
                                ...
                                >
                                    I believe that great work deserves a great
                                    online presence—a Digital Showroom built
                                    with the same attention to detail you bring
                                    to your craft. My approach combines
                                    technical excellence with strategic thinking
                                    to engineer a site that not only looks
                                    beautiful but is designed to turn your
                                    expertise into high-value clients.
                                </motion.p>
                            </div>
                        </motion.div>
