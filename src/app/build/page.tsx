    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 hero-gradient">
      <main className="container section-padding-block">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Social Proof */}
          <div className="bg-white dark:bg-gray-800 rounded-xl p-8 mb-16 border border-build-100 dark:border-gray-700 shadow-sm">
            <div className="flex flex-col sm:flex-row gap-6 items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  — Austin Lowther, Creator of <a href="https://langlibros.com" target="_blank" rel="noopener noreferrer" className="text-build-600 hover:text-build-700 dark:text-build-400 dark:hover:text-build-300">LangLibros</a>
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Booking Section */}
          <div id="booking" className="bg-white dark:bg-gray-800 rounded-xl p-8 border-2 border-build-200 dark:border-gray-700 shadow-lg scroll-mt-24">
