    ...
    <div className="min-h-screen bg-gray-50 hero-gradient">
      <main className="container section-padding-block" role="main">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-12 items-end mb-16">
            ...
            <div className="text-left order-2 lg:order-1 lg:col-span-2">
              <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-6 animate-fadeInUp leading-tight">
              ...
              <p className="text-xl md:text-2xl text-gray-600 animate-fadeInUp animation-delay-100">
            ...
            <div className="relative flex justify-center lg:justify-end animate-fadeInUp animation-delay-200 order-1 lg:order-2 lg:col-span-1">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-gray-100 via-white to-gray-200 rounded-full opacity-60 blur-3xl transform scale-110"></div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <section aria-labelledby="service-options" className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            >
              <div className="text-left">
                ...
                <h3 className="text-2xl font-semibold text-gray-900 mb-4 group-hover:text-fix-600 transition-colors">
                  Improve My Product
                </h3>
            ...
            >
              <div className="text-left">
                ...
                <h3 className="text-2xl font-semibold text-gray-900 mb-4 group-hover:text-build-600 transition-colors">
                  Build My Idea
                </h3>
                <p className="text-gray-600 mb-4">
          ...
          <div 
            ref={testimonialRef}
            className={`bg-white rounded-lg p-6 mt-12 border border-gray-200 shadow-sm max-w-3xl mx-auto transition-all duration-700 ${
          ...
          >
            ...
            <p className="text-sm text-gray-500 text-center mt-3">
              — Austin Lowther, Creator of <a href="https://langlibros.com" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900">LangLibros</a>
            </p>
          </div>

          {/* Inline Not Sure CTA */}
          <div className="text-center mt-8">
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 max-w-lg mx-auto">
