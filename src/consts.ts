...
export const SITE_TAGLINE = "Contract Product Engineer";
export const SITE_DESCRIPTION =
  "I join B2B SaaS teams as a contract product engineer, building customer-facing products, internal tools, and HubSpot integrations.";
