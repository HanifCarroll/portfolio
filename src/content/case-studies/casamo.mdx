...
import casamoFeature from '../../assets/img/projects/casamo-product-surface.jpg';
...
<section class='case-study-detail__editorial-section case-study-detail__editorial-section--media'>
	...
	<div class='case-study-detail__editorial-copy'>
		...
		<MacWindowFrame ariaLabel='Casamo stay audit product surface'>
			<ImagePlate image={casamoFeature} alt="Casamo sample report showing a recommended stay, evidence scores, missing proof, and host questions." />
		</MacWindowFrame>
	</div>
</section>
