...
<section class='case-study-detail__editorial-section case-study-detail__launch-proof'>
	...
	<div class='case-study-detail__editorial-copy'>
		<ProofRows rows={shippedRows}>
			Codex Telegram Bridge turns an agent workflow into a controlled local product. It defines ownership boundaries first, then adds
			automation where state, routing, and recovery are explicit.
		</ProofRows>
	</div>
</section>
