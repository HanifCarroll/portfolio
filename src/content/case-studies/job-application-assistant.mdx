...
<CaseSection title="From scattered application pieces to one local workflow">
...
<CaseSection title="The missing link between a role and a submission">
...
<CaseSection title="State stays local; judgment stays reviewable">
...
<CaseSection title="The side panel keeps the application in view" media>
...
<CaseSection title="The contracts behind a trustworthy draft">
...
<CaseSection title="A draft that remains tied to its evidence">
