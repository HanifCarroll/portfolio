...
<CaseSection title="The side panel keeps the application in view">
...
<section class="case-study-detail__editorial-section case-study-detail__launch-proof">
  ...
  <div class="case-study-detail__editorial-copy">
    <ProofRows rows={shippedRows}>
      Job Application Assistant connects extraction, context, drafting, artifact generation, and
      ledger state. It is not a black-box application agent.
    </ProofRows>
  </div>
</section>
