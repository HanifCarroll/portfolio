...
<CaseSection title="Research Into Product Decisions">
...
<CaseSection title="From Wireflow to Product" media wideMedia>
...
<CaseSection title="Exchange Discovery" media>
...
<CaseSection title="The Product Loop">
...
<CaseSection title="Private Coordination" media>
...
<CaseSection title="Engineering Direction">
  <DecisionBlock title="Consolidate the maintained product into one web stack.">
    The implementation moved through several forms: an early Rails API, a separate web client, and mobile experiments. I eventually consolidated the maintained product into Laravel 12, Inertia, and Vue 3.

    The final repository keeps server-side product rules, typed routes, Vue pages, real-time events, queues, and deployment configuration together. PostgreSQL stores product state, Redis supports cache and real-time infrastructure, and the production setup separates the app, queue worker, WebSocket server, proxy, and data services in containers.
