...
<section class='case-study-detail__editorial-section case-study-detail__launch-proof'>
	...
	<div class='case-study-detail__editorial-copy'>
		<ProofRows rows={shippedRows}>
			<p>
				LinkedIn Tools is a practical example of controller-led browser automation: state first, action ownership second, and audit evidence
				available when the browser result needs to be checked.
			</p>
		</ProofRows>
	</div>
</section>
