...
import acquirePhoto from '@src/assets/img/projects/acquire-pursuits.png';
import casamoPhoto from '@src/assets/img/projects/casamo-homepage-viewport.jpg';
import desarmaderoOperationsPhoto from '@src/assets/img/projects/desarmadero-operations-ventas.png';
...
export const serviceOffers: Record<ServiceOfferKey, ServiceOffer> = {
		...
		proof: [
			{
				...
				image: acquirePhoto,
				imageAlt: 'Acquire macOS command center showing the Pursuits workflow for submitted applications.',
			...
			},
			{
				...
				image: desarmaderoOperationsPhoto,
				imageAlt: 'Desarmadero operations prototype showing the counter-sales workflow and live order summary.',
				imageClass: 'object-left-top'
			}
		],
		faqs: [
	...
	systemsBuild: {
		...
		chooserSummary: 'For teams that already know the bottleneck and need the internal tool, automation, dashboard, or AI workflow built.',
...
export const serviceOfferList: ServiceOffer[] = [serviceOffers.audit, serviceOffers.systemsBuild, serviceOffers.fractional];
